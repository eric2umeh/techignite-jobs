...
export async function createJob(data: z.infer<typeof jobSchema>) {
  ...
  const jobPost = await prisma.jobPost.create({
    data: {
      ...
      status: "ACTIVE", // Default to ACTIVE when creating new jobs
    },
  })
...
export async function updateJobPost(data: z.infer<typeof jobSchema>, jobId: string) {
  ...
  await prisma.jobPost.update({
    ...
    data: {
      ...
      listingDuration: validatedData.listingDuration,
      benefits: validatedData.benefits,
      status: validatedData.status, // Include status in update
    },
  })
...
export async function editJobPost(jobId: string, data: z.infer<typeof jobSchema>) {
  const user = await requireUser()
